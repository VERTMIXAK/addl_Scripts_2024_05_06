...
def main(args):
  ...
  # jgp start
  print('runoff_file.variables ',runoff_file.variables)
  print('runoff_file.variables[args.runoff_var]  ',runoff_file.variables[args.runoff_var])
  # jgp end

  rvr_nj, rvr_ni = runoff_file.variables[args.runoff_var].shape[-2:]
  rvr_res = 360.0/rvr_ni
  # jgp start
  print('rvr_res ',rvr_res)
  # jgp end
  rvr_lon = numpy.arange(0.5*rvr_res, 360., rvr_res)
  rvr_lat = numpy.arange(-90.+0.5*rvr_res, 90., rvr_res)

  # jgp start
  print('rvr_nj, rvr_ni   ',rvr_nj, rvr_ni)
  print('rvr_lat  ',rvr_lat)
  print('rvr_lon  ',rvr_lon)
  # jgp end
