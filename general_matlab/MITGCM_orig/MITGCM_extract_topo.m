...
if strcmp(srcfile,'/home/hsimmons/DATA/TOPO/topo30.grd')
	s_x=nc_varget(srcfile,'lon')-360; s_y=nc_varget(srcfile,'lat');
...
elseif strcmp(srcfile,'/home/hsimmons/PROJ/TTide/DATA/oz_bathy_large')
%    keyboard
    %%
    load(srcfile)
    %%
    lon=bathy.lon-360;lat=bathy.lat;H=bathy.H;
%    keyboard
