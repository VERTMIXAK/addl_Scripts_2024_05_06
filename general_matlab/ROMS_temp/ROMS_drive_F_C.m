...
%     roms.jgp_base  = '/import/c/w/jpender/roms-kate_svn/';

    [~,dum2]=unix('pwd |rev | cut -d "/" -f4-10 | rev');
    roms.jgp_base=[dum2(1:end-1),'/'];
    
    roms.cdfdir = '/netcdf_All/';
    ...
    %/import/c/w/jpender/roms-kate_svn/TS_0.125/Experiments/TS_0.125_2012_001_TidesM2_10plus5_meso/
