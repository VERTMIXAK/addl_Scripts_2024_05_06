...
% calculate contacts for S.grid(rg).refine_factor = 0
...
% jgp maybe this is for 1:1 refinement. i.e. 0 rather than 1
...
% jgp original  if (G(dg).refine_factor <= 1 && G(rg).refine_factor <= 1)
