...
names=("shflux"     "Vwind"     "lwrad_down" "lhflux" 	  "Tair"      "swrad")
times=("shflux_time" "wind_time" "lrf_time"   "lhflux_time" "tair_time" "srf_time")

longNames=names

longNames[0]="Sensible_heat_net_flux_surface_3_Hour_Average"
