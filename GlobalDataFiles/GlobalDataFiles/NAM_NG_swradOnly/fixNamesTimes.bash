...
names=("Pair" "Qair" "Tair" "lwrad_down" "swrad_up" "swrad_down" "Uwind" "Vwind" "albedo" "cloud")
times=("pair_time" "qair_time" "tair_time"  "lrf_time" "srf_time" "srf_time" "wind_time" "wind_time" "albedo_time" "cloud_time")


source ~/.runPycnal
python rescale.py             			NAM_albedo_$year.nc_ORIG albedo
python rescale.py             			NAM_cloud_$year.nc_ORIG cloud
echo "about to do T"
