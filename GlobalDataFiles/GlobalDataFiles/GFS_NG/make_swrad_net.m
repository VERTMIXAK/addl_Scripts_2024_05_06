upFile   = 'GFS_swradUp_2020.nc';
downFile = 'GFS_swradDown_2020.nc';
netFile  = 'GFS_swradNet_2020.nc';

swradUp   = nc_varget(upFile,  'swradUp');
swradDown = nc_varget(downFile,'swradDown');

lat = nc_varget(upFile,'lat');
lon = nc_varget(upFile,'lon');
time = nc_varget(upFile,'srf_time');
